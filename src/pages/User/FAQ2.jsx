            ...
            <button
                ...
                className={`px-6 py-3 rounded-full text-lg font-medium transition-all duration-300 ease-in-out
                    ${currentPage === 0
                        ...
                        : 'bg-[#3F9540] text-white hover:bg-[#2E7C30] focus:outline-none focus:ring-2 focus:ring-[#3F9540] focus:ring-opacity-75 cursor-pointer' // Warna utama dan sedikit lebih gelap saat hover
                    }`}
            >
                &larr; Sebelumnya
            </button>
